...
Frontend (Node.js): docker.io/avaliacaon2/fatec-scs-imagem-dockshield-frontend

Backend (Flask): docker.io/avaliacaon2/fatec-scs-imagem-dockshield-backend

Database (MongoDB): docker.io/avaliacaon2/fatec-scs-imagem-dockshield-db
...
A documentação técnica completa do projeto encontra-se disponível no diretório /docs deste repositório, contendo:
